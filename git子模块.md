...
[![img](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/aca776ce1d75b12a790985fbc9fc1bef100x100.webp)](https://juejin.cn/user/4318537403872727)

[换个号退隐江湖i![lv-2](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/lv-2.99ba5b2.png)](https://juejin.cn/user/4318537403872727)

2022年05月19日 15:17 · 阅读 481

## 项目背景

因公司项目要拆成多个模块，部分模块给分公司的小伙伴开发权限一起开发，所以最终决定使用 git 子模块来拆分项目，今天来复盘下项目拆分中爬过的一些坑。有兴趣的同学可以参考源码一起阅读，附[源码](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Ffecym%2Fgit-submodules.git)。

## 文章导览

![文章导览](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/996de9767d9f45f7adf5ee247972396ctplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
![查看子模块](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/3fb566decd594cbc80e6c5fcafa83d90tplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
1. 此时我们使用 `git submodules` 就可以看到添加成功的子模块了
...
![git-status](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/9234fc3a464943abb64ff7d2fad6f1b4tplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
自动注册路由就是用 webpack 中的的 `require.context` api 来注册，还不了解 `require.context` 的话可以看一下我的另一篇文章[webpack 拓展](https://link.juejin.cn/?target=https%3A%2F%2Fchengyuming.cn%2Fviews%2Fwebpack%2Fwebpack-3.html)
...
![@vue/cli-service](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/6d112095bf8d4d0db885ee748bf4ab0ctplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
![githooks](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/b70afd7a7d7d4a72afe3913db262dc72tplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
![pre-commit](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/494fa15a28574c6f8abc8c1f2f93120atplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
PS：完整钩子说明，请参考[官网链接](https://link.juejin.cn/?target=https%3A%2F%2Fgit-scm.com%2Fdocs%2Fgithooks)

### husky

githooks 保存在 .git 文件夹中。git 是一个多人协作工具，那按理说 git 仓库中的所有文件都应该被跟踪并且上传至远程仓库的。但是有个例外，.git 文件夹不会，这就导致一个问题，我们在本地配置好 githooks 后，怎么分享给其他小伙伴儿呢？copy 吗？那未免太 low 了，都用 git 了还 copy，也太不优雅了。这时候我们可以用 [husky](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Ftypicode%2Fhusky)

husky 是一个让配置 git 钩子变得更简单的工具。husky 的原理是让我们在项目根目录中写一个配置文件，然后在安装 husky 的时候把配置文件和 githooks 关联起来，这样我们就能在团队中使用 githooks 了。也可以直接执行 `husky install` 来生成 githooks，husky 不是很了解的同学可以看我另外一篇文章 [eslint 工作流](https://link.juejin.cn/?target=https%3A%2F%2Fchengyuming.cn%2Fviews%2FFE%2Flint%2F)
...
![install.js](git%E5%AD%90%E6%A8%A1%E5%9D%97.assets/7e142c74347044e695da7fb88d1a12adtplv-k3u1fbpfcp-zoom-in-crop-mark4536000.png)
...
1. [原文链接](https://link.juejin.cn/?target=https%3A%2F%2Fchengyuming.cn%2Fviews%2Ftools%2Fgit%2Fgit-submodules.html)
2. [Config Files](https://link.juejin.cn/?target=https%3A%2F%2Fbabeljs.io%2Fdocs%2Fen%2Fconfig-files)
3. [Vue CLI git hook](https://link.juejin.cn/?target=https%3A%2F%2Fcli.vuejs.org%2Fzh%2Fguide%2Fcli-service.html%23git-hook)
4. [一文带你彻底学会 Git Hooks 配置](https://link.juejin.cn/?target=https%3A%2F%2Fsegmentfault.com%2Fa%2F1190000022970270)